...
TEST(structTest, imageRead2) {
    EXPECT_NO_FATAL_FAILURE(
            imageRead("/home/oem/Practice/Rice/pix/1233.JPG"));
}

TEST(structTest, imageRead3) {
    EXPECT_THROW(imageRead("/home/oem/Practice/Rice/pix/1233.jpg"),std::invalid_argument);
}

TEST(structTest, imageRead4) {
    EXPECT_THROW(
            imageRead("//home/oem/Practice/Rice/pix/"),std::exception);
}
...
TEST(getFileListTest, listTest4) {
    std::string path = "/home/oem/Practice/Rice/pix/";
    EXPECT_NO_THROW(getFileList(path));
}
